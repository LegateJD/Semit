package com.zakharov.mykyta.lab2.presentation.viewmodel;
...
import com.zakharov.mykyta.lab2.domain.entity.LogicalSymbol;
import com.zakharov.mykyta.lab2.presentation.viewmodel.mapper.SymbolMapper;
import com.zakharov.mykyta.lab2.presentation.viewmodel.util.ResourcesProvider;
import com.zakharov.mykyta.lab2.presentation.viewmodel.util.SingleEventLiveData;
...
public class CalculatorViewModel extends ViewModel {
    ...
    private MutableLiveData<Spannable> currentEquation = new MutableLiveData<>(new SpannableString(EMPTY_STRING));

    public LiveData<Spannable> currentEquation() {
        return currentEquation;
    }

    private MutableLiveData<String> currentResult = new MutableLiveData<>(EMPTY_STRING);
